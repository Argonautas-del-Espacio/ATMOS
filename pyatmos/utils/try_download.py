...
def wget_download(url, save_path, timeout=30, chunk_size=8192):
    """
    ...
    while True:
        try:
            ...
            with requests.get(url, stream=True, timeout=timeout) as r:
                ...
                progress_bar = tqdm(total=total_size, unit='iB', unit_scale=True, desc=f"Downloading (Attempt {attempt})")
